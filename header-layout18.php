...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
			...
			<div class="header-ftc header-<?php echo esc_attr($smof_data['ftc_header_layout']); ?>">
				<div class="header-content  <?php echo esc_attr(implode(' ', $header_classes)); ?>">
					<div class="container">
						...
						<div class="nav-right-group left-menu">
							<div class="nav-right">
								<?php if( class_exists('YITH_WCWL') && isset($smof_data['ftc_enable_tiny_wishlist']) && $smof_data['ftc_enable_tiny_wishlist'] || isset($smof_data['ftc_header_language']) && $smof_data['ftc_header_language'] || isset($smof_data['ftc_header_currency']) && $smof_data['ftc_header_currency']): ?>
						...
						<div class="nav-right-group right-menu">
		...
		<div class="site-content-contain">
			<div id="content" class="site-content body-home21">
