                ...
                <div class="admin-bar9">
                    <div class="container">
                        ...
                        <?php if( isset($smof_data['ftc_header_contact_information']) && $smof_data['ftc_header_contact_information']): ?>
                            <div class="left-9">
                                <?php echo wp_kses_post(do_shortcode(stripslashes($smof_data['ftc_header_contact_information']))); ?>
                            </div>
                        <?php endif; ?>
                        <div class="logo-wrapper is-desktop"><?php ftc_theme_logo(); ?></div>

                        <div class="right-10">
                            <?php if( isset($smof_data['ftc_social_header']) && $smof_data['ftc_social_header']): ?>
                                <div class="social-header">
                                    <?php echo wp_kses_post(do_shortcode(stripslashes($smof_data['ftc_social_header']))); ?>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
