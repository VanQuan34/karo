...
?>
	<div class="related-posts related related-portfolio <?php echo esc_attr(($is_slider)?'loading':'') ?>" id="<?php echo esc_attr($rand_id); ?>">
		<header class="theme-title">
			...
			<h3 class="heading-title"><?php esc_html_e('Related Portfolio', 'karo'); ?></h3>
			...
			<p class="tit-rela"><?php esc_html_e('Praesent dapibus, neque id cursus faucibus, tortor neque egestas augue, eu vulputate magna eros eu erat. ','karo') ?></p>
		</header>
