                    ...
                    <div class="ftc_account_form dropdown-container">
                        <form name="ftc-login-form" class="ftc-login-form" action="<?php echo esc_url(wp_login_url()); ?>" method="post">
                            ...
                            <p class="login-password">
                                ...
                                <input type="password" name="pwd" class="input" value="" size="20" autocomplete="on">>
                            </p>
...
function ftc_cart_total() {
    ob_start();
    ?>
    <div class="cart-total"><span class="text-cart"><?php echo esc_html_e('Cart','karo'); ?></span><span class="cart-ico"><?php echo WC()->cart->get_cart_contents_count() ?></span></div>
    <?php
    return ob_get_clean();
}
