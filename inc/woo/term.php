...
class Ftc_Custom_Product_Category{
	...
	function add_category_fields(){
		...
		<div class="form-field ftc-product-cat-upload-field">
			<label><?php esc_html_e( 'Breadcrumbs Background Image', 'karo' ); ?></label>
			...
			<div class="button-wrapper">
				...
				<button type="button" class="button upload-button"><?php esc_html_e('Upload/Add image', 'karo') ?></button>
				<button type="button" class="button remove-button"><?php esc_html_e('Remove image', 'karo') ?></button>
			</div>
		</div>
		
		<div class="form-field">
			<label for="layout"><?php esc_html_e( 'Layout', 'karo' ); ?></label>
			<select name="layout" id="layout">
				<option value=""><?php esc_html_e('Default', 'karo') ?></option>
				<option value="0-1-0"><?php esc_html_e('Fullwidth', 'karo') ?></option>
				<option value="1-1-0"><?php esc_html_e('Left Sidebar', 'karo') ?></option>
				<option value="0-1-1"><?php esc_html_e('Right Sidebar', 'karo') ?></option>
				<option value="1-1-1"><?php esc_html_e('Left & Right Sidebar', 'karo') ?></option>
			</select>
		</div>
		
		<div class="form-field">
			<label for="left_sidebar"><?php esc_html_e( 'Left Sidebar', 'karo' ); ?></label>
		...
		<div class="form-field">
			<label for="right_sidebar"><?php esc_html_e( 'Right Sidebar', 'karo' ); ?></label>
		...
		<div class="form-field ftc-product-cat-upload-field">
			<label><?php esc_html_e( 'Banner', 'karo' ); ?></label>
			<div class="preview-image">
				<?php echo wc_placeholder_img( 'thumbnail' ); ?>
			</div>
			<div class="button-wrapper">
		...
		<div class="form-field ftc-product-cat-upload-field">
			<label><?php esc_html_e( 'Icon', 'karo' ); ?></label>
			<div class="preview-image">
				<?php echo wc_placeholder_img( 'thumbnail' ); ?>
			</div>
			<div class="button-wrapper">
		...
		<div class="form-field">
			<label><?php esc_html_e( 'Top border color', 'karo' ); ?></label>
	...
	function edit_category_fields( $term, $taxonomy ){
		...
		<tr class="form-field ftc-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Breadcrumbs Background Image', 'karo' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php 
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Layout', 'karo' ); ?></label></th>
			<td>
				<select name="layout" id="layout">
					<option value="" <?php selected($layout, ''); ?>><?php esc_html_e('Default', 'karo') ?></option>
					<option value="0-1-0" <?php selected($layout, '0-1-0'); ?>><?php esc_html_e('Fullwidth', 'karo') ?></option>
					<option value="1-1-0" <?php selected($layout, '1-1-0'); ?>><?php esc_html_e('Left Sidebar', 'karo') ?></option>
					<option value="0-1-1" <?php selected($layout, '0-1-1'); ?>><?php esc_html_e('Right Sidebar', 'karo') ?></option>
					<option value="1-1-1" <?php selected($layout, '1-1-1'); ?>><?php esc_html_e('Left & Right Sidebar', 'karo') ?></option>
				</select>
			</td>
		</tr>
		
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Left Sidebar', 'karo' ); ?></label></th>
			<td>
				<select name="left_sidebar" id="left_sidebar">
					<option value="" <?php selected($left_sidebar, ''); ?>><?php esc_html_e('Default', 'karo') ?></option>
					<?php foreach( $sidebar_options as $sidebar_id => $sidebar_name ): ?>
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Right Sidebar', 'karo' ); ?></label></th>
			<td>
				<select name="right_sidebar" id="right_sidebar">
					<option value="" <?php selected($right_sidebar, ''); ?>><?php esc_html_e('Default', 'karo') ?></option>
					<?php foreach( $sidebar_options as $sidebar_id => $sidebar_name ): ?>
		...
		<tr class="form-field ftc-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Banner', 'karo' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php
		...
		<tr class="form-field ftc-product-cat-upload-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Icon', 'karo' ); ?></label></th>
			<td>
				<div class="preview-image">
					<?php
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label><?php esc_html_e( 'Top border color', 'karo' ); ?></label></th>
