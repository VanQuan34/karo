...
if( !empty($smof_data['ftc_enable_quickshop']) && ftc_has_woocommerce() && !class_exists('Ftc_Quickshop') ){
	...
	class Ftc_Quickshop{
		...
		function add_quickshop_button(){
			...
			echo '<a class="quickview" href="'.esc_url($href).'"><i class="icon-magnifier"></i><span class="ftc-tooltip button-tooltip">'.esc_html__('Quick view', 'karo').'</span></a>';
		}
		...
		function add_hook(){
			...
			add_action('woocommerce_after_shop_loop_item', array($this, 'add_quickshop_button'), 99);
					...
					<div class="image-items owl-carousel">
						<?php foreach( $image_ids as $image_id ): ?>
							...
							<div class="image-item">
								<a href="<?php echo esc_url($image_link); ?>" class="swipebox">
