...
.text2_home22 p, .elementor-widget-text-editor h1, h4.footer-title-mid-23,  h2.logo-text-24, .heading_blog1 h1, .elementor-element .footer-mid-23 h3, .text-gl-home24 p, .text-gl-2-home24 .elementor-text-editor h2, .text-gl-2-home24 .elementor-text-editor span a, .elementor-element .footer-title-mid-24
{
...
footer a, .ftc-sb-testimonial .testimonial-content .byline, .elementor-widget-ftc-products-tabs .style_2 .woocommerce .product .item-description h3.product_title,.elementor-widget-text-editor,.header-layout20 .ftc-search-product .ftc-search .search-button, .ftc-categories .product-count, .menu-mobile > div.mobile-account a
, .ftc-element-testimonial .infomation, 
.ftc-element-testimonial h4.name, .blog-home23 .ftc-blogs-slider .post-text .meta, .elementor-widget-ftc-products-tabs .tab-title, .ftc-product-tabs .style_2 .woocommerce .product .item-description .meta_info .add-to-cart a span, .ftc-readmore, .ftc-product-categories.style_2 .item-desciption h3.title, .ftc-element-team  .ftc-team-member .excerpt, .ftc-element-testimonial .testimonial-content .content-info .infomation , .single-product .summary.entry-summary .caftc-link span a, .single-product .summary.entry-summary .tags-link span a, ul.ftc-product-tabs-filter li{
  font-family: <?php echo esc_html($ftc_secondary_body_font) ?>;
}
#cboxClose:before, .ftc-search-product .ftc-search .search-button{
	 font-family: <?php echo esc_html($ftc_secondary_body_font) ?> !important;
}
body,
.site-footer,
.woocommerce div.product form.cart .group_table td.label,
...
.elementor-widget-ftc-products-tabs .style_2 .woocommerce .products .product .images a.compare:hover i:before, .elementor-widget-ftc-products-tabs .style_2 .woocommerce .products .product .images .quickview:hover i:before, .elementor-widget-ftc-products-tabs .style_2 .woocommerce .product .images .group-button-product > div.yith-wcwl-add-to-wishlist a:hover i:before, .elementor-widget-ftc-products-tabs .style_2 .woocommerce .product:hover .item-description .meta_info .add-to-cart a,.header-layout20 #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-menu-ancestor > .item_link *,.header-layout20 #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li:hover > .item_link *, .blog-home23 .navigation-slider .nav-prev:hover:before,
.blog-home23 .navigation-slider .nav-next:hover:before,.header-layout20 .cart-total .cart-ico,
.link-footer-item-home23 a:hover, .copy-left a, .copy-left a:hover, .tab-title.active,
.cate-slide-home24 .navigation-slider .nav-prev:hover:before, .cate-slide-home24 .navigation-slider .nav-next:hover:before, h2.logo-text-24, .copy-left-24 a, .copy-left-24 a:hover, .ftc-element-testimonial .avatar-image:before, .style_3 .woocommerce .product .item-description .meta_info .compare:hover, .footer-mid-23 ul li a:hover, .cop-left a:hover, .cop-left a, .tog-ftbot24 .link-ft-home24 li a:hover, .tog-ftmid24 .link-footer-item-home24 li a:hover, .elementor-element .cop-left-24 a:hover, .elementor-element .cop-left-24 a, .icon-footer24 .footer-icon-min li a:hover, .header-layout20 .mobile-button .mobile-nav i:hover:before, .elementor-element .woocommerce .products .product .images .compare.added:hover, footer ul.bullet li a:hover, .ftc-footer .copy-com a:hover, .footer-middle21 ul li a:hover, .ftc-sb-button a.ftc-button:hover, .woocommerce .load-more-wrapper .button:hover, .woocommerce .product-not-slide.products-v2 .product .item-description .meta_info a:hover, .elementor-widget-ftc-products-tabs .style_3 .woocommerce .product .images .group-button-product .quickview:hover i:before
{
...
#mega_main_menu.primary > .menu_holder > .menu_inner > ul > li:hover > .item_link, #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li > .item_link:hover, #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li > .item_link:focus, #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-menu-ancestor > .item_link, #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-page-ancestor > .item_link, #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-post-ancestor > .item_link, #mega_main_menu.primary > .menu_holder > .menu_inner > ul > li.current-menu-item > .item_link,.footer-home23, .woocommerce .products:not(.list).style_2 .product .images .group-button-product > div a:hover,
.woocommerce .products:not(.list).style_2 .product .images .group-button-product > a:hover, .woocommerce .products:not(.list).style_3 .product .images .group-button-product > div a:hover,
